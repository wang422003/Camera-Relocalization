...
if __name__ == "__main__":
    ...
    # Train model
    model = PoseNet_valid.create_PoseNet_valid('PoseNet_valid.npy', True) # GoogLeNet (Trained on Places)
    adam = Adam(lr=0.001, clipvalue=1.5)
    model.compile(optimizer=adam, loss={'cls1_fc_pose_xyz': PoseNet_valid.euc_loss1x, 'cls1_fc_pose_wpqr': PoseNet_valid.euc_loss1q,
                                        'cls2_fc_pose_xyz': PoseNet_valid.euc_loss2x, 'cls2_fc_pose_wpqr': PoseNet_valid.euc_loss2q,
                                        'cls3_fc_pose_xyz': PoseNet_valid.euc_loss3x, 'cls3_fc_pose_wpqr': PoseNet_valid.euc_loss3q})
